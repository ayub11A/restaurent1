...
function Footer() {
 ...
 <h1 className="text-green-500 text-2xl -mt-5 "> <span className="text-white"> <span className="text-amber-400">K</span><span className="text-red-900 ">C</span></span> </h1>
       <h2 className="mt-5 -ml-7 "> <span className="text-red-500  ">chicken</span><span className="text-black">&</span ><span className="text-amber-200">chips</span> </h2>
