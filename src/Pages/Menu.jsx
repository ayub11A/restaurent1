...
function Menu() {
  ...
  const handleAddToCart = (item) => {
    ...
    addToCart(item, tableNumber); // ✅ Add item to CartContext
  ...
  return (
    <div className="p-4 md:p-6 mt-20 relative">
      {/* Toast */}
      {toast && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white font-medium px-4 py-2 rounded-lg shadow-lg z-[9999]">
          {toast}
        </div>
      )}
