...
return ( <div className="p-4 md:p-6 mt-20 relative">
{/* Toast Message */}
{toast && ( <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white font-medium px-4 py-2 rounded-lg shadow-lg z-[9999]">
{toast} </div>
)}
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
    ...
    {filteredList.length === 0 && (
      <p className="col-span-full text-center text-gray-500 mt-4">
        Ma jiro menu item u dhigma search-kaaga.
      </p>
    )}
  </div>
</div>
